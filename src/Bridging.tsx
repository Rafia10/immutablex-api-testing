...
import { token } from '@imtbl/core-sdk/dist/src/contracts/factories/@openzeppelin/contracts';
...
const Bridging = ({client, link, wallet}: BridgingProps) => {
  ...
  async function completeWithdrawalNFT() {
    ...
    // complete an NFT withdrawal from Client(Backend)
  async function completeWithdrawalBackend(){
    await client.completeWithdrawal({
      starkPublicKey:'0x4527be8f31e2ebfbef4fcaddb5a17447b27d2aef',
      token:{
